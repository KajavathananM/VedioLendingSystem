...
<form name = "abc" action="DeleteCustomer"><table>
	...
	<td><button type="submit" value="Delete" name="Delete"
						style="background-color: black; color: white ;align:right">DELETE CUSTOMER</button></td>
						</form>
						
	<form>
	<td><button type="submit" value="Update" name="Update" 
						style="background-color: black; color: white; align:left">UPDATE CUSTOMER</button></td></table></form>
